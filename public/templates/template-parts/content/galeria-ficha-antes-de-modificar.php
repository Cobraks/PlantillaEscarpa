...
//$tipo_gallería_exterior = 'Gallería exterior';

 // Función para mostrar la galería con miniaturas
...
<!-- Botón conmutador -->
<!-- <h2>Total fotos: <?php /* echo $total_fotos ?></h2>
<h2>Total fotos interior: <?php echo $total_fotos_interior ?></h2>
<h2>Total fotos exterior: <?php echo $total_fotos_exterior */?></h2> -->
...
<div class="contenedor-galeria" id="contenedor-galeria-exterior">
  <!-- Contenido de la galería Exterior --><?php
...
<!-- Contenedor de galería Interior -->
...
mostrar_galeria_con_miniaturas($galeria_interior, 'galeria-interior','Fotografías interior', $nombre_marca, $nombre_modelo,$int_or_ext,$fotos_por_galeria); 
  ...
  <!-- Contenido de la galería Interior -->
