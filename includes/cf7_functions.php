<?php
/**
 * Añadimos los campos de ACF de opciones, y más datos, a los shortcodes.
 *  @package gv360
 */
 // Proteger contra el acceso directo al archivo
defined( 'ABSPATH' ) or die( 'Acceso directo no permitido.' );

if ( function_exists( 'wpcf7' ) ) {
    add_filter( 'wpcf7_special_mail_tags', 'wpcf7_special_mail_tags_coche', 10, 3 );
    function wpcf7_special_mail_tags_coche( $output, $name, $html ) {
    ...
    function my_wpcf7_mail_sent_function( $contact_form ) {
        global $gv360_post_title, $gv360_form_data;
        ...
        if ( $form_title == 'Me interesa' ) { // Reemplaza 'Me interesa' por el título de tu formulario
            ...
            if ( $submission ) {
               ...
               $fecha_hora_consulta = current_time('Y-m-d H:i:s');
